...
class NoteInput extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      body: '',
      // TODO [Advanced] state untuk pesan error
      error: ''
    };
  ...
  onSubmitEventHandler(event) {
    ...
    console.warn(' Submit note', this.state);
  }
      ...
      <div className="note-input" data-testid="note-input">
        ...
        >
          ...
          <p
            ...
            style={remainingChars < 10? { color: '#ffb74d' } : {}}
          >
